---
title: Sinchronizuoti projekto faktinius duomenis tiesiai iš „Project Service Automation“ į projekto integravimo žurnalą, kad būtų galima registruoti finansų ir operacijų srityje
description: Šiam straipsnyje aprašomi šablonai ir pagrindinė užduotys, kurios naudojamos norint sinchronizuoti projekto faktinius duomenis tiesiogiai iš „Microsoft Dynamics 365 Project Service Automation“ į finansų ir operacijų aplinką.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
---
# <a name="synchronize-project-actuals-directly-from-project-service-automation-to-the-project-integration-journal-for-posting-in-finance-and-operations"></a>Sinchronizuoti projekto faktinius duomenis tiesiai iš „Project Service Automation“ į projekto integravimo žurnalą, kad būtų galima registruoti finansų ir operacijų srityje

[!include[banner](../includes/banner.md)]

Šiam straipsnyje aprašomi šablonai ir pagrindinė užduotys, kurios naudojamos norint sinchronizuoti projekto faktinius duomenis tiesiogiai iš „Dynamics 365 Project Service Automation“ į „Dynamics 365 Finance“.
...
[![„Project Service Automation“ integravimo su finansais ir operacijomis duomenų srautas](./media/ProjectActualsFlow.jpg)](./media/ProjectActualsFlow.jpg)
