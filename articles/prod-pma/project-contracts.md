...
description: Šiame straipsnyje pateikiami projekto sutarčių, kurias galite kurti įvairiems projektų tipams ir finansavimo šaltiniams, pavyzdžiai, taip pat sutarčių tvarkymo ir sąskaitų faktūrų išrašymo projektų klientams pavyzdžiai.
author: Yowelle
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
