...
description: Šiame straipsnyje pateikiama informacija apie optinio simbolių atpažinimo (OCR) apdorojimą kvitams. Ši funkcija skirta pagerinti vartotojo patirtį, kai išlaidų ataskaitos kuriamos programoje " Microsoft Dynamics 365 Finance".
author: stsporen
ms.date: 05/14/2020
ms.topic: article
ms.prod: ''
