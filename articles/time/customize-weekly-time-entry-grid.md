...
3. Įtraukite pasirinktinį lauką į eilutės redagavimo užduočių srautą arba langelio redagavimo užduočių srautą.

Reikia įsitikinti, ar naujas laukas turi reikiamus tikrinimus eilutės arba langelio redagavimo užduočių sraute. Atlikdami šį žingsnį, užrakinkite lauką pagal laiko įrašo būseną.
...
Į dialogo langą **Laiko įrašo spartusis kūrimas** įtraukite pasirinktinį lauką. Tada įtraukiant laiko įrašus bus galima įvesti laiko reikšmes pasirenkant **Naujas**.
...
#### <a name="customize-a-view-and-add-a-custom-field"></a>Rodinio tinkinimas ir pasirinktinio lauko įtraukimas

Tinkinkite rodinį **Mano savaitės laiko įrašai** ir įtraukite į jį pasirinktinį lauką. Galite pasirinkti pasirinktinio lauko padėtį ir dydį tinklelyje redaguodami šias ypatybes rodinyje.
