...
- Jei kuriate naują šabloną, turite įtraukti stulpelį, kuriame palaikomas vidinės įmonės laikas ir išlaidos. Pasirinkite **Įtraukti sąlygos stulpelį** ir įveskite naujo stulpelio pavadinimą, pvz., **LegalEntity**. Įveskite stulpelio sąlygą, kur, jei **msdyn\_contractorganizationalunitid.msdyn\_name** yra \<organizational unit\>, tada \<enter the legal entity\>; kitaip nulis.
...
[![Šablonų susiejimas](./media/ActualsMapping.jpg)](./media/ActualsMapping.jpg)

[![Šablonų susiejimas](./media/TransactionConnections.jpg)](./media/TransactionConnections.jpg)
...
[![Šablonų susiejimas](./media/ActualsUpdateMapping.jpg)](./media/ActualsUpdateMapping.jpg)

[![Šablonų susiejimas](./media/TransactionConnectionsUpdate.jpg)](./media/TransactionConnectionsUpdate.jpg)
