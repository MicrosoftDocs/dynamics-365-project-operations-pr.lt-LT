...
Danys turi klestinčią Microsoft technologijos praktiką. Darius ir Diana yra C\# kūrėjai, bet Diana yra Jungtinėse Valstijose, o Darius yra Indijoje. Daugeliui projekto užduočių reikia išteklių iš Danys Indija ir Danys JAV bei Dariui ir Dianai reikia turėti tokį patį saugos prieigos lygį į šios praktikos srities projektus. Tačiau Danys Indija kūrėjų samdymo kaštai gerokai skiriasi nuo Danys JAV kūrėjų kaštų.
...
3. Susiekite Dianą su Danys JAV ir Darius su Danys Indija.
4. Priskirkite tinkamus sąnaudų kainoraščius abiems organizaciniams vienetams. Taip galėsite garantuoti, kad Dariui ir Dianai projekte įrašytos sąnaudos teisingai atspindi sąnaudų tarp Danys JAV ir Danys Indija skirtumą.
...
Danys turi du plėtros centrus: Danys JAV ir Danys Indija. Šių dviejų plėtros centrų išteklių sąnaudos labai skiriasi.

Danys parduoda IT paslaugas daugelyje tarptautinių rinkų, pvz., Lotynų Amerikoje, Šiaurės Amerikoje, Azijoje ir Ramiojo vandenyno regione, Vakarų Europoje ir Artimuosiuose Rytuose. Tų pačių projektų vaidmenų įkainiai šiose rinkose gali labai skirtis.

Danys JAV ir Danys Indija turėtų būti nustatyti kaip organizaciniai vienetai ir kiekvienas organizacinis vienetas turėtų turėti savo sąnaudų kainoraštį. Azija – Ramusis vandenynas, Lotynų Amerika, Šiaurės Amerika, Vakarų Europa ir Artimieji Rytai turėtų būti nustatyti kaip pardavimo teritorijos, o kiekviena pardavimo teritorija turėtų turėti nuosavą pardavimo kainoraštį.
...
- Danys Indija - SAP Praktika - Techniniai Konsultantai 
- Danys Indija - SAP Praktika - Funkciniai Konsultantai       
- Danys Indija - Microsoft Technologijos Praktika Funkciniai konsultantai 
- Danys Indija - Microsoft Technologijos Praktika Funkciniai konsultantai 
- Danys JAV - SAP Praktika - Techniniai Konsultantai  
- Danys JAV – SAP Praktika – Funkciniai Konsultantai  
- Danys JAV - Microsoft Technologijos Praktika - Techniniai Konsultatai 
- Danys JAV - Microsoft Technologijos Praktika - Funkciniai Konsultantai
